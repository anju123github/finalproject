  ...
  <?php include('navbar.php') ?>
    ...
    <div class="container">
       ...
       <form action="#" class="border rounded p-md-3 p-2 mt-lg-5 mt-md-3 mt-1" style="background: white;">
        ...
        <div class="h4 font-weight-normal"> Contact us</div>
        ...
        <div class="row">
            ...
            <div class="col-12 py-3">
                ...
                <input type="submit" value="ok" name="complaint_submit" class="btn btn-block btn-dark" style="font-size: small !important; background: #2d5a83;">
